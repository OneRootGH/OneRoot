...
ROLE_DESCRIPTIONS = {
    ...
    "kitchen-food-counter": "Runs food preparation, food orders, and the Cold Store & Kitchen counter.",
...
STAFF_ROLE_DESCRIPTIONS = {
    ...
    "General Counter Operator": "Runs both POS counters from one login, serves all counter product groups, issues receipts, records credit customers, and completes the daily handover.",
    ...
    "Kitchen & Food Counter Officer": "Prepares and serves food, manages food orders, and keeps Cold Store & Kitchen ready for fast service.",
...
MODULES: dict[str, ModuleDefinition] = {
    ...
    "kitchen_recipe_plans": ModuleDefinition(
        ...
        fields=[
            ...
            FieldDefinition("kitchenCategory", "Kitchen Category", "select", False, KITCHEN_ORDER_CATEGORY_OPTIONS),
            FieldDefinition("recipeSummary", "Preparation Notes (Optional)", "textarea"),
            ...
            FieldDefinition("productionStatus", "Session Stage", "select", True, [("Planned", "Set up"), ("In Production", "Preparing"), ("Ready", "Ready to sell"), ("Completed", "Closed after sales"), ("Cancelled", "Cancelled")]),
            FieldDefinition("notes", "Internal Notes (Optional)", "textarea"),
        ],
    ),
    "equipment_rental_bookings": ModuleDefinition(
        ...
        fields=[
            ...
            FieldDefinition("customerName", "Customer Name", "text", True),
            FieldDefinition("customerPhone", "Customer Phone", "text"),
            FieldDefinition("rentalDays", "Chargeable Days (Automatic)", "number", False, step="1"),
            FieldDefinition("rentalFee", "Rental Charge (Automatic)", "number", True),
            FieldDefinition("costAmount", "Service Cost", "number"),
            FieldDefinition("amountPaid", "Amount Paid", "number"),
            FieldDefinition("paymentDate", "Payment Date", "date"),
            FieldDefinition("paymentMethod", "Payment Method", "select", False, [(m, m) for m in PAYMENT_METHODS]),
